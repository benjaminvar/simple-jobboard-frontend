    ...
    <section class="sidebar">
      <!-- <ul class="sidebar-menu" data-widget="tree">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="header"><router-link to="">Empresa</router-link></li>
          <li><router-link to="/">Resumen</router-link></li>
          <li><router-link to="/me">Información de la empresa</router-link></li>
          <li><router-link to="/me/security">Seguridad</router-link></li>
          <li class="header"><router-link to="/offers">Ofertas de Trabajo</router-link></li>
          <li><router-link to="/offers">Ver Ofertas de Trabajo</router-link></li>
           <li><router-link to="/offer/add">Agregar Oferta de Trabajo</router-link></li>
          <li><router-link to="/applications">Solicitudes de Empleo</router-link></li>
          </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
